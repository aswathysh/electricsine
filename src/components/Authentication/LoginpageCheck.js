...
import {
  ...
  createUser,
  forgetPasswordLogin,
} from "@/services/Auth/AuthenticationServices";
...
export default function LoginPage() {
  ...
  const forgetMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast.success(
        "New Password sended to your email. Please check your email.",
        {
          autoClose: 5000,
          style: { fontSize: "16px", fontWeight: 600 },
        },
          ...
          <section className="lp-right" aria-label="Login form">
            <div className="lp-form-card">
              <div className="back-url">
                <button onClick={handleBack} className={`lp-submit-b`}>
                  ← Back
                </button>
              </div>
              ...
              <form className="lp-form" onSubmit={handleSubmit} noValidate>
                  ...
                  <>
                    <div className="lp-field">
                      ...
                      {errors.username && validate && (
                        <span className="lp-error">{errors.username}</span>
                      )}
                    </div>
                ...
                {activeTab === "login" && !forgot && (
                  <div className="lp-field">
                    <label className="lp-label" htmlFor="lp-userid">
                      User Id
                    </label>
                    <input
                      onChange={handleChange}
                ...
                {activeTab === "login" && !forgot && (
                  <div className="lp-remember-row">
                    ...
                    <a onClick={handleForgot} className="lp-forgot">
                      Forgot Password
                    </a>
                  </div>
                )}
