...
import CartItemCard from "@/components/sharables/CartItemUpdared";
...
export default function Home() {
  ...
  const removeItem = (index) => {
    ...
    const newTotalPrice =
      Math.round((totalPrice - removedItemPrice) * 100) / 100;
          ...
          <div style={{ ...styles.fullwidth }}>
            ...
            <Grid container style={{ ...styles.center, ...styles.fullwidth }}>
              ...
              <Grid
                item
                size={{ xs: 12, md: 12, lg: 12, sm: 12 }}
                className="hide_above_mob"
                style={{ ...styles.contentleft, ...styles.padding }}
              >
                <p style={styles.subheading}>Total: {totalPrice}₹</p>
              </Grid>

              {/* Left Column: Cart Items */}
              <Grid
                item
                size={{ xs: 12, md: 8, lg: 8, sm: 12 }}
                style={{
                  ...styles.contentleft,
                  ...styles.padding,
                  ...styles.column,
              ...
              {/* Right Column: Desktop Price Summary & Checkout */}
              <Grid
                item
                size={{ xs: 0, md: 4, lg: 4, sm: 0 }}
                className="hide"
                style={{
                  ...styles.contentleft,
                  ...styles.padding,
              ...
              >
                <p style={styles.subheading}>Total</p>
                <div className="cart-price-col">
                  <div>
                    <span className="cart-discount-dec">
                      <ArrowDownIcon />
                      {"17"}%
                    </span>

                    <span className="cart-mrp-dec">
                      ₹
                      {Math.round(
                        Number(totalPrice) / (1 - 0.17),
                      ).toLocaleString("en-IN")}
                    </span>
                  </div>

                  <span className="cart-price-dec">
...
// Fixed DM Serif headings to match reference styling rules perfectly
const styles = {
  padding: {
    padding: "2%",
  },
